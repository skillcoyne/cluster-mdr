...
public class CenterDialog extends JDialog {
	...
	public void addNotify() {
		...
		final Dimension size = new Dimension(getWidth() + insets.left
		...
		this.setBounds((owner.width - size.width) / 2 + owner.x,
				(owner.height - size.height) / 2 + owner.y, size.width, size.height);
	}
}
