...
/**
 * Manages a group of threads. The threads in the pool will be started at the same time and interrupted at the same time, and the pool
 * itself will wait until all threads terminate before terminating itself.
 */
